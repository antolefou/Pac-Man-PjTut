...
public class Pacman extends Deplacement {
    ...
    private final Image imagePacman = new Image(Objects.requireNonNull(getClass().getResourceAsStream(       "pacmanUp.gif")));
    private final Image imagePacmanEtourdi = new Image(Objects.requireNonNull(getClass().getResourceAsStream("pacmanEtourdi.gif")));
    private final Image imagePacmanGele = new Image(Objects.requireNonNull(getClass().getResourceAsStream(   "pacmanGele.gif")));
    ...
    public void competenceProjectile() {
        ...
        Image imageProjectile= new Image(Objects.requireNonNull(getClass().getResourceAsStream("projectile.gif")));
