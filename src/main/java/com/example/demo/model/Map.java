...
//    Graphe
    ...
    public Map() {
        ...
        this.imageMur = new Image(Objects.requireNonNull(getClass().getResourceAsStream(         theme.get(0))));
        this.imageGomme = new Image(Objects.requireNonNull(getClass().getResourceAsStream(        "Gomme.png")));
        this.imageSuperGomme = new Image(Objects.requireNonNull(getClass().getResourceAsStream(   "SuperGomme.png")));
        this.imageBoost = new Image(Objects.requireNonNull(getClass().getResourceAsStream(        "boost.png")));
        this.imageMurFantome = new Image(Objects.requireNonNull(getClass().getResourceAsStream(   "murFantome.png")));
        this.imageTeleporteur = new Image(Objects.requireNonNull(getClass().getResourceAsStream(  "teleporteur.gif")));
        this.imageCerise = new Image(Objects.requireNonNull(getClass().getResourceAsStream(       "cerise.png")));
        this.imageFraise = new Image(Objects.requireNonNull(getClass().getResourceAsStream(       "fraise.png")));
        this.imageOrange = new Image(Objects.requireNonNull(getClass().getResourceAsStream(       "orange.png")));
        this.imagePomme = new Image(Objects.requireNonNull(getClass().getResourceAsStream(        "pomme.png")));
        this.imageMelon = new Image(Objects.requireNonNull(getClass().getResourceAsStream(        "melon.png")));
        this.imageVaisseau = new Image(Objects.requireNonNull(getClass().getResourceAsStream(     "vaisseau.png")));
        this.imageCloche = new Image(Objects.requireNonNull(getClass().getResourceAsStream(       "cloche.png")));
        this.imageClef = new Image(Objects.requireNonNull(getClass().getResourceAsStream(         "clef.png")));
//        init
